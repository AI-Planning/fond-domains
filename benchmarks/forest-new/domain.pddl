(define (domain forest)
     ...
     (:types
          ...
          ;;;;;;;subproblem;;;;;;;
          sub-location log-location package truck plane city block
     )
     (:constants
          ;;;;;;;sub-problem types;;;;;
     ...
     (:action initialize-grid
          :parameters (?slocx ?slocy - sub-location ?locx ?locy - location)
     ...
     (:action s-up-x
          :parameters (?sloc1x ?sloc1y ?sloc2x - sub-location ?locx ?locy - location)
     ...
     (:action s-up-y
          :parameters (?sloc1x ?sloc1y ?sloc2y - sub-location ?locx ?locy - location)
          :precondition (and (initialized ?locx ?locy)
               (problem-at ?locx ?locy grid)
