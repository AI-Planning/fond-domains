(define (problem nim)
	...
	(:init
		...
		(successor s1_20 s1_21)
		(successor s1_21 s1_22)
		(successor s1_22 s1_23)
		(successor s1_23 s1_24)
		(successor s1_24 s1_25)
		(successor s1_25 s1_26)
		(successor s1_26 s1_27)
		(successor s1_27 s1_28)
		(successor s1_28 s1_29)
		(successor s1_29 terminal)
		(turn p0)
	)
