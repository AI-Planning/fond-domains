...
(define (domain faults)
        ...
        (:action perform_operation_1_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (not_fault f1) (not_fault f2))
        ...
        (:action perform_operation_2_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (not_fault f2))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action finish
                :parameters ()
                :precondition (and (completed o1) (completed o2))
                :effect (made)
        )
)