(define (domain faults)
 ...
 (:action perform_operation_1_fault
  ...
  :effect (oneof (and (completed ?o) (not (not_completed ?o))  (not_fault f1) (not_fault f2) (not_fault f3)) (and (completed ?o) (not (not_completed ?o))
 ...
 (:action perform_operation_2_fault
  ...
  :effect (oneof (and (completed ?o) (not (not_completed ?o))  (fault f1) (not_fault f2) (not_fault f3)) (and (completed ?o) (not (not_completed ?o))
 ...
 (:action perform_operation_3_fault
  ...
  :effect (oneof (and (completed ?o) (not (not_completed ?o))  (fault f1) (fault f2) (not_fault f3)) (and (completed ?o) (not (not_completed ?o))
