...
(define (domain faults)
        ...
        (:action perform_operation_1_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (not_fault f1) (not_fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7))
        ...
        (:action perform_operation_2_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (not_fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action perform_operation_3_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (fault f2) (not_fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action perform_operation_4_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (fault f2) (fault f3) (not_fault f4) (not_fault f5) (not_fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action perform_operation_5_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (fault f2) (fault f3) (fault f4) (not_fault f5) (not_fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action perform_operation_6_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (fault f2) (fault f3) (fault f4) (fault f5) (not_fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action perform_operation_7_fault
                ...
                :effect (oneof
                        (and (completed ?o) (not (not_completed ?o)) (fault f1) (fault f2) (fault f3) (fault f4) (fault f5) (fault f6) (not_fault f7))
                        (and (completed ?o) (not (not_completed ?o))
        ...
        (:action finish
                :parameters ()
                :precondition (and (completed o1) (completed o2) (completed o3) (completed o4) (completed o5) (completed o6) (completed o7))
                :effect (made)
        )
)